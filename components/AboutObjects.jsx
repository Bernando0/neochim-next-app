  ...
  return (
    <section id="objects-section" className="objects-block">
        ...
        <div className="objects-text">
          ...
          <h4>Завод Hyundai Motor</h4>
          <p><strong>Адрес:</strong> г. Алматы, 7-ая ул. 138/5</p>
          <p><strong>Описание:</strong> Завод Hyundai Motor выделяется современным дизайном и высоким качеством обслуживания. Благодаря нашей резиновой краске, 
          оборудование получило долговечное покрытие, устойчивое к механическим повреждениям и внешним воздействиям.</p>
